    ...
    <div className="container">
      <Editable name="about">
        <div className="d-flex">
          <div className="col-sm-6 text-white">
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  Upon registration, you can choose to be an admin. You will
                  then be able to edit the content of some pages.
                </li>
              </ul>
            </div>
            <br />
            <div>
              <p>
                I have also added links to my social media accounts at the
                footer of the site in case some of you would like to reach out
                to me for any questions or just for a conversation.
              </p>
            </div>
            <br />
            <div>
          ...
          <div className="col-sm-8 d-flex justify-content-center align-items-start">
            <img
