      ...
      <Editable name="about">
        <div className="row">
          <p className="col-sm-6 text-white align-self-center">
            ...
            equipment that I currently own as a record collector and enthusiast.
          </p>
        </div>
        <br />
        <div className="row">
          <p className="col-sm-6 text-white align-self-center">
            On this site I have used an API to pull information from my account
            on www.discogs.com - the biggest library/platform for music
            collectors
          </p>
        </div>
        <br />
        <div className="row">
          <p className="col-sm-6 fw-bold text-warning align-self-center">
            To be able to access the collection page you must register an
            account first!
          </p>
        </div>
        <br />
        <div className="row">
          <p className="col-sm-6 text-white align-self-center">
            ...
            releases to your cart and if you will wish to buy some of them,
            there is a purchase button within the cart that will redirect you
            straight to the purchase page of a specific release on discogs.com
          </p>
        </div>
        <br />
        <div className="row">
